...
<!-- Mirrored from inversweb.com/product/html/reeni/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:22:14 GMT -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-content">
                        <div class="logo">
                            <a href="index.html">
                                <img class="logo-dark" src="{{asset('assets/images/logo/white-logo-reeni.png')}}"
                                    alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                                <img class="logo-white" src="{{asset('assets/images/logo/logo-white.png')}}"
                                    alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                            </a>
                        </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-footer-wrapper border-right mr--20">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{asset('assets/images/logo/white-logo-reeni.png')}}"
                                        alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                                </a>
                            </div>
                        ...
                        <div class="single-footer-wrapper contact-wrap">
                            ...
                            <ul class="ft-link tmp-scroll-trigger animation-order-1 tmp-link-animation">
                                <li><span class="ft-icon"><i class="fa-solid fa-phone"></i></span><a href="#">017345 678
                                        9101</a></li>
                                <li><span class="ft-icon"><i
                                            class="fa-solid fa-location-dot"></i></span>Cumilla,Bangladesh</li>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-1.png')}}"
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-02.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-2.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-03.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-3.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-04.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-4.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-05.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-5.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-06.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-6.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-07.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-7.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-08.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-8.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-09.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-9.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-10.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-10.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-11.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-11.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-12.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-12.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-13.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-13.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-14.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-14.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-15.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-15.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-16.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-16.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-17.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-17.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-18.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-18.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-19.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-19.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-20.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-20.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-21.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-21.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-22.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-22.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-23.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-23.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-24.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-24.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-25.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/25..webp')}}""
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="index-25.html">Demo 25</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#">
                                                    <img class="w-100" src="{{asset('assets/images/demo/coming-soon.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                            ...
                            <div class="row">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-1-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-02-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-2-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-03-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-3-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-04-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-4-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-05-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-5-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-06-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-6-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-07-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-7-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-08-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-8-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-09-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-9-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-10-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-10-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-11-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-11-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-12-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-12-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-13-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-13-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-14-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-14-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-15-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-15-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-16-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-16-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-17-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-17-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-18-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-18-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-19-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-19-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-20-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-20-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-21-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-21-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-22-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-22-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-23-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-23-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-24-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/home-24-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-25-white.html">
                                                    <img class="w-100" src="{{asset('assets/images/demo/25-white..webp')}}""
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="index-25-white.html">Demo 25</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#">
                                                    <img class="w-100" src="{{asset('assets/images/demo/coming-soon-white.png')}}"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
...
<!-- Mirrored from inversweb.com/product/html/reeni/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2026 09:23:18 GMT -->
